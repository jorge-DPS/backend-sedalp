...
*/
        ...
        Route::get(
            '/news/trash',
            [NewsTrashController::class, 'index']
        )->middleware('can:news.trash.view');

        Route::post(
            '/news/{news}/restore',
            [NewsTrashController::class, 'restore']
        )
            ->whereNumber('news')
        ...
        Route::delete(
            '/news/{news}/force',
            [NewsTrashController::class, 'forceDelete']
        )
            ->whereNumber('news')
            ->middleware('can:news.force_delete');
